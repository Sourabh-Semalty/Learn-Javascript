...
// if (markBMI > johnBMI) console.log(`Mark BMI ${markBMI} is higher than John BMI ${johnBMI}`)
...
// console.log(dolphines === koalas ? "It is a draw" : (dolphines > koalas ? 'dolphines wins the match' : 'koalas wins the match'))
...
console.log(`The bill is ${bill} with tip ${tip} and total is ${bill + tip}`)
